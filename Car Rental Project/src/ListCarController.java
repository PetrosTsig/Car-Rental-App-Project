...
public class ListCarController {
    ...
    // Button that saves the data of the new car
    @FXML
    void ListCar(ActionEvent event) {

        String output;
        String SQL = "INSERT INTO cars(brand,model,plate,color) values('" + brand.getText() + "','"
                + model.getText() + "','" + plate.getText() + "','" + color.getText() + "')";// SQL Query
        try {
