...
public class ResSceneController {
    ...
    // Button that saves the data of a new reservation
    @FXML
    void resacar(ActionEvent event) {
        String output;
        String SQL = "INSERT INTO reservations(name,surname,plate,checkin,returndate) values('" + name.getText() + "','"
                + surname.getText() + "','" + plate.getText() + "','" + datein.getValue() + "','"
                + returndate.getValue() + "')";// SQL Query
        try {
